...
function fillOperatorsList(i){
  $("#operatorsList").append("<tr id='operator"+i+"' style='cursor:pointer'><td>"+ operatorUsers[i].firstName +"</td><td>"+ operatorUsers[i].lastName +"</td><td>"+ operatorUsers[i].userName +"</td></tr>");
}
